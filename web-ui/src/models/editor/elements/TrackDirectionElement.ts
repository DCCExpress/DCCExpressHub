...
import type { TrackDirectionElementDto } from "../../../domain/layout/layoutDto";
import { Point } from "../../../domain/Rect";
import { drawTextWithRoundedBackground } from "../../../graphics";
import { generateId } from "../../../helpers";
import { TrackElement } from "../core/TrackElement";
import { DrawOptions, ITrackDirectionElement } from "../types/EditorTypes";
export class TrackDirectionElement extends TrackElement {
  ...
  override type: typeof ELEMENT_TYPES.TRACK_DIRECTION = ELEMENT_TYPES.TRACK_DIRECTION;
  ...
  static fromJSON(data: ITrackDirectionElement): TrackDirectionElement {
